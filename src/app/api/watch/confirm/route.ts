...
import { resolveWatchLocale, type WatchMessageLocale } from '@/lib/watch/notificationText';
import {
  activateWatch,
  consumeConfirmToken,
  enqueueEvent,
...
// Exported for the locale-parity test below (route.test.ts): the page is
// the third locale-carrying surface alongside notificationText.ts and
// messages/*.json, and a missing/empty field here renders a broken page
// for exactly one language.
